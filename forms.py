...
class ContactForm(Form):
  ...
  date = TextField("Date (mm/dd/yyyy)",[validators.InputRequired("Please enter the event date")])
  description = TextAreaField("Event Description")
  image = FileField("Event image - jpg or png")
  media = FileField("Event media - pdf only")
